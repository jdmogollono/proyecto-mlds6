...
def main():
    ...
    df_promedios = calcular_promedios(df)
    df_promedios = df_promedios.drop(columns=['HR_CAL_MN_D', 'HR_CAL_MX_D', 'NV_MEDIA_D', 'NV_MN_D', 'NV_MX_D', 'TMN_CON', 'TMX_CON'])

    # Guardar el resultado en un archivo CSV
    output_path = os.path.join(DATA_FOLDER, 'data_promedios.csv')
